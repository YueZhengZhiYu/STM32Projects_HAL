...
#include "../../../OLED/Drivers/OLED/OLED.h"
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  /*第一行*/
	  OLED_ShowString(0,0,"OLED",16,0);
	  OLED_ShowCHinese(32,0,7,0); 
	  OLED_ShowCHinese(48,0,8,0); 
	  ...
	  OLED_ShowString(32,3,"A236112",16,0);
