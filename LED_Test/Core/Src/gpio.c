...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(Buzzing_GPIO_Port, Buzzing_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Buzzing_Pin LED_1_Pin LED_2_Pin LED_3_Pin
                           LED_4_Pin */
  GPIO_InitStruct.Pin = Buzzing_Pin|LED_1_Pin|LED_2_Pin|LED_3_Pin
                          |LED_4_Pin;
